...
public class MyChatClient implements ActionListener {
  ...
  public void appendUserList(ArrayList<String> userList){
    	 
    	 for(int i=0; i<userList.size(); i++) {
    		 //1. 유저명단 컴포넌트 초기화 (기존정보삭제)
    		 //2. 새로운 명단(userLiset)을 유저명단 컴포넌트에 추가
    		System.out.println(userList);
    		 
    		 // a.textLabel(userList.get(i));
    	 }
     }
...
//                    MyChatClient.this.appendMessage(in.readUTF());
                	...
                	if (obj instanceof String) {  //modified 0817. team2
                		MyChatClient.this.appendMessage((String)obj);  //modified 0817. team2
