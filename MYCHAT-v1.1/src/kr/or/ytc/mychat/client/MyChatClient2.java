 ...
 */ 
public class MyChatClient2 implements ActionListener {
    Frame f; 
    Panel p; 
    Button bSend; 
    ...
    //초기화
    public MyChatClient2(String name) { 
        this.name = name; 
        f = new Frame(name); 
        p = new Panel(); 
        bSend = new Button("전송");
...
//                    MyChatClient.this.appendMessage(in.readUTF());
                	...
                	if (obj instanceof String) {  //modified 0817. team2
                		MyChatClient2.this.appendMessage((String)obj);  //modified 0817. team2
